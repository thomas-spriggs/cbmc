...
#include <solvers/verbose_stack_decision_procedure.h>
...
solver_factoryt::get_smt2(smt2_dect::solvert solver)
{
  ...
  if(filename.empty())
  {
    ...
    auto smt2_dec = util_make_unique<verbose_stack_decision_proceduret<smt2_dect>>(
      ns,
      "cbmc",
  ...
  {
    auto smt2_conv = util_make_unique<verbose_stack_decision_proceduret<smt2_convt>>(
      ns,
      "cbmc",
      std::string("Generated by CBMC ") + CBMC_VERSION,
      "QF_AUFBV",
